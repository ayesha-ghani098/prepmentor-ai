...
export const dashboardPage = "min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 p-6";
...
export const dashboardWelcomeContent = "flex justify-between items-center";
...
export const dashboardMetricsGrid = "grid grid-cols-1 md:grid-cols-2 gap-6 mb-8";
export const dashboardMetricCard = "bg-gradient-to-br from-indigo-500 via-purple-500 to-blue-500 text-white shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105";
...
export const dashboardLowScoreHeader = "flex items-center justify-between mb-6";
...
export const dashboardLowScoreCardContent = "flex justify-between items-start";
export const dashboardLowScoreQuestionText = "font-semibold text-gray-800 mb-2 text-lg";
export const dashboardLowScoreMeta = "flex items-center gap-4 mb-3";
...
export const dashboardQuickActionsGrid = "grid grid-cols-1 md:grid-cols-3 gap-6";
...
export const answerPage = "min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 p-6";
export const answerContainer = "max-w-7xl mx-auto";
export const answerHeader = "mb-8";
export const answerTitle = "font-bold text-gray-800 mb-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent text-3xl";
export const answerGrid = "grid grid-cols-1 lg:grid-cols-2 gap-8";
export const answerQuestionCard = "bg-white/80 backdrop-blur-sm shadow-lg rounded-2xl border border-white/20 p-6";
...
export const answerFeedbackCard = "bg-white/80 backdrop-blur-sm shadow-lg rounded-2xl border border-white/20 p-6";
...
export const answerScoreHeader = "flex justify-between items-center mb-3";
